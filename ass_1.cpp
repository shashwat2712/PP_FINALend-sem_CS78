...
// Class to store the candidate's different details
...
//Created a global array 'c' with over 50 members.
candidate_info c[50];
...
void take_candidate_info()
{
    ...
    cin>>c[i].name;//input the name

    cout<<"\n\t\t\t\tEnter the father name of the candidate: ";
    fflush(stdin);
    cin>>c[i].father_name;//input the father name of the candidate

    cout<<"\n\t\t\t\tEnter the mother name of the candidate: ";
    fflush(stdin);
    cin>>c[i].mother_name;////input the mother name of the candidate

    cout<<"\n\t\t\t\tEnter the date of birth of the candidate in the format (date-month-year): ";
    fflush(stdin);
    cin>>c[i].dob;//input the name date of birth of the candidate

    cout<<"\n\t\t\t\tEnter age: ";
    cin>>c[i].age;//input the age

    cout<<"\n\t\t\t\tEnter the enrollment number of the candidate starting from 1 : ";
    cin>>c[i].roll;//input the roll number of the candidate

    cout<<"\n\t\t\t\tEnter the chemistry marks of the candiate :";
    cin>>c[i].chem_marks;//input the chemistry marks

    cout<<"\n\t\t\t\tEnter the physics marks of the candiate :";
    cin>>c[i].phy_marks;//input the physics marks

    cout<<"\n\t\t\t\tEnter the maths marks of the candiate :";
    cin>>c[i].math_marks;//input the maths marks

    cout<<"\n\t\t\t\tEnter the home town:";
    cin>>c[i].district;//input the district

    cout<<"\n\t\t\t\tEnter the all india rank of the candidate :";
    cin>>c[i].all_india_rank;//input the all India rank
    ...
    cout<<"\n\t\t\t\t3--->SC";
    cout<<"\n\t\t\t\t4--->ST  : ";
    cin>>c[i].category_number;//input the category                              
    cout<<endl;
...
void display(){
    cout<<"\n------------------------------------------------------------------------------------\n";
    cout<<"|                               JOINT ENTRANCE EXAMINATION                           |\n";
    cout<<"|------------------------------------------------------------------------------------\n";
    cout<<"|Name: %s\tCategory: %dth\tRoll Number: %d\n", c[i].name, c[i].category_number, c[i].roll;
    cout<<"|Father name: %s\t JEE rank :%d\n", c[i].father_name,c[i].all_india_rank;
    cout<<"|Mother name: %s\n",  c[i].mother_name;
    cout<<"|Date of birth: %s\n",  c[i].dob;
    cout<<"|District: %s\n",  c[i].district;
    cout<<"|------------------------------------------------------------------------------------\n";
    cout<<"|\tSUBJECTS      \tMAX MARKS\tMIN MARKS NEEDED\tTHEORY MARKS\n";
    cout<<"|------------------------------------------------------------------------------------\n";
    cout<<"|\tPhysics      \t  100      \t   33       \t\t     %d\n",c[i].phy_marks;
    cout<<"|\tMaths       \t  100      \t   33       \t\t     %d\n", c[i].math_marks;
    cout<<"|\tChemistry      \t  100      \t   33       \t\t     %d\n", c[i].chem_marks;
    cout<<"|------------------------------------------------------------------------------------\n";
    cout<<"|\t              \t  300    |    GRAND TOTAL\t    %f\n", total(c[i].phy_marks,c[i].math_marks,c[i].phy_marks);
...
void modify(){
    ...
    cin>>c[position].name;
    cout<<"\n\t\t\t\tEnter the father name of the candidate: ";
    cin>>c[position].father_name;
    cout<<"\n\t\t\t\tEnter the mother name of the candidate: ";
    cin>>c[position].mother_name;
    cout<<"\n\t\t\t\tEnter the date of birth of the candidate in the format (date-month-year): ";
    fflush(stdin);
    cin>>c[position].dob;
    cout<<"\n\t\t\t\tEnter age: ";
    cin>>c[position].age;
    cout<<"\n\t\t\t\tEnter the chemistry marks of the candiate :";
    cin>>c[position].chem_marks;
    cout<<"\n\t\t\t\tEnter the physics marks of the candiate :";
    cin>>c[position].phy_marks;
    cout<<"\n\t\t\t\tEnter the maths marks of the candiate :";
    cin>>c[position].math_marks;
    cout<<"\n\t\t\t\tEnter the home town:";
    cin>>c[position].district;
    cout<<"\n\t\t\t\tEnter the all india rank of the candidate :";
    cin>>c[position].all_india_rank;
...
int jee_log(){
    ...
    cout<<"The Joint Entrance Examination (JEE) is an engineering entrance"
    ...
    cin>>Number_of_candidates_enrolled;
...
void advance_qualification(){
    ...
    if (flag == 1) 
        {cout<<"As per the category criteria \n";
        ...
        if(c[position].category_number ==1 ){
            cout<<"The candidate belong to general category \n";
            if(c[position].percentile>=90){
                cout<<"The candidate has qualified for jee advanced \n";
            }
        }

        else if(c[position].category_number ==2 ){
            cout<<"The cadidate belongs to the OBC category \n";
            if(c[position].percentile>=83){
                cout<<"The candidate has qualified for jee advanced \n";
            }
        }
        else if(c[position].category_number ==3 ){
            cout<<"The cadidate belongs to the SC category \n";
            if(c[position].percentile>=75){
                cout<<"The candidate has qualified for jee advanced \n";
            }
        }
        else if(c[position].category_number ==4 ){
            cout<<"The cadidate belongs to the ST category \n";
            if(c[position].percentile>=60){
                cout<<"The candidate has qualified for jee advanced \n";
            }
        }
        else{
            cout<<"Enter the correct category \n";
        }
    }
}
...
double percentile_calculator(int rank){
    ...
    if((Number_of_candidates_enrolled !=0)|| (Number_of_candidates_enrolled >= rank))
    {
        ...
        cout<<"Please enter the correct number of the students attempted the exam \n";
    }
    return percentile;
}
...
void record_the_entry(){
    ...
    fclose(fptr); 
    cout<<"Data is successful is loaded \n"; 
}
...
int main(){
    ...
    while(loop_terminater == 1)
    {
        ...
        cout<<"\n\n\t\t\t\t3. Modify Student";
        cout<<"\n\n\t\t\t\t4. Record the recent entry into the text file";
        ...
        case 7:
            cout<<"Enter the rank: ";
            cin>>arbitrary_rank;
            cout<<"The percentile is : %lf",percentile_calculator(arbitrary_rank);
